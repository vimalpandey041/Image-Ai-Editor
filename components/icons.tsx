...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm0 2a8 8 0 100 16 8 8 0 000-16zM12 9a3 3 0 110 6 3 3 0 010-6z" />
  </svg>
);
...
export const BackgroundIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-4.5-4.5-4.5 4.5m9-6l-4.5 4.5-4.5-4.5" opacity="0.4"/>
  </svg>
);

export const ResizeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15m11.25-6l-5.25 5.25m5.25-5.25v4.5m0-4.5h-4.5m4.5 0L15 9" />
  </svg>
);
...
export const MagicWandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.622-3.385m-5.043.025a15.998 15.998 0 01-3.388-1.621m7.732 5.043a3 3 0 00-1.128-5.78 2.25 2.25 0 01-2.245-2.4 4.5 4.5 0 00-2.245-8.4c-.798 0-1.563.13-2.285.364m-1.118 6.074a15.998 15.998 0 00-1.622 3.385m3.388-1.62a15.998 15.998 0 01-5.043-.025m5.043-.025a15.998 15.998 0 01-1.622 3.385m-3.388-1.62a15.998 15.998 0 011.622 3.385m-5.043-.025a15.998 15.998 0 00-3.388 1.622m7.732-5.043a3 3 0 005.78 1.128 2.25 2.25 0 012.4 2.245 4.5 4.5 0 008.4 2.245c0 .399-.078.78-.22 1.128m-8.182-3.385a15.998 15.998 0 00-3.388 1.622" />
  </svg>
);
...
export const FlipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.691L12 12m0 0l-3.181-3.182m0 0l-3.181 3.182M12 12l3.181 3.182" />
    </svg>
);
